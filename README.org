#+TITLE: VSAG extension for SQLite
#+DATE: 2024-12-04T22:55:37+0800
#+LASTMOD: 2024-12-16T10:36:40+0800
#+AUTHOR: Jiacai Liu
...
This extension provide a virtual table allowing users to add vectors to VSAG and do KNN searching.
